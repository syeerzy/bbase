...
;;; oop:dispatch-table implementation based on object-lambda
;; for internal use only
;;; quick-hack mode on for now

;;; (oop:dispatch-table delegate [msg args body] ...)
;;;    delegate   is a binding for another oop:dispatch-table (gives inheritance)
...
(define-syntax oop:dispatch-table
  (let ()
    (import scheme)
